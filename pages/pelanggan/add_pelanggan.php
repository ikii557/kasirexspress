    ...
    if (isset($_POST['simpan'])) {
        if (tambahpelanggan($_POST) > 0) {
            ...
            echo "<script>
                ...
                document.location.href = 'add_pelanggan.php';
                </script>";
        }
    }
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">  
                                ...
                                <div class="page-wrapper">
                                  <p class="p-3" style="font-size: 20 px; font-family: 'Serif', sans-serif;">add pelanggan</p>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        <h4 style="font-weight: bold;">Tambah Pelanggan</h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="pelanggan.html">data pelanggan</a>
                                                        </li>
                                                        <li class="breadcrumb-item"><a href="edit_pelanggan.html">edit pelanggan  </a>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card p-5">
                                                    <div class="card-header">
                                                        <h1 class="text-center" style="font-size: 50px; font-family: 'Serif', sans-serif;">Tambah Data Pelanggan</h1>
                                                    </div>
                                                    <form action="" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <h6 class="p-2"><em>Email</em></h6>

                                                            <div class="input-group">
                                                                <input type="unyque" name="email" id="email " class="form-control" placeholder="Tambah Email" >
                                                                <span class="md-line"></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <h6 class="p-2"><em>No. Handphone</em></h6>
                                                            <div class="input-group">
                                                                <input type="text" name="no_hp" class="form-control" placeholder="Tambah No. Handphone" >
                                                                <span class="md-line"></span>
                                                            </div>
                                                        </div>
                                                        <form>
                                                            <button type="submit" name="simpan"  class="btn btn-success float-right  "  style="border-radius: 5px;">Simpan</button>
                                                           </form>
                                                    </form>
                                                </div>
                                            </div>
