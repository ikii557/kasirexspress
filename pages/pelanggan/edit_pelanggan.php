<?php
    require '../../fungsi/fungsipelanggan.php';
        ...
        $id = $_GET['id'];
        if ($id) {
            $querypelanggan = "SELECT * FROM pelanggan WHERE id = '$id'";
            $query = mysqli_query($conn, $querypelanggan);
            $pelanggan = mysqli_fetch_assoc($query);
    }


    if (isset($_POST['edit'])) {
        if (editpelanggan($_POST, $id) > 0) {
            echo "<script>
            ...
            echo "<script>
                    alert('pelanggan gagal diedit');
                    document.location.href='pelanggan.php?id=$id';
                </script>";
        }
    }
?>
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left" >
                            <li class="header-notification m-t-9 active" style="font-size: 15px;">
                                <span class=" m-t-9 text-c-blue" style="font-size: 15px; font-family: 'Times New Roman', sans-serif;">Kasirexspress</span>
                            </li>
                        </ul>
                        <ul class="nav-right">
                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body"> 
                                ...
                                <div class="page-wrapper">
                                            <!-- Data widget start -->
                                             <p class="p-2" style="font-size: 25px; font-family: 'Times New Roman', sans-serif;">Edit Pelanggan</p>
                                             <!-- Page-header start -->
                                             <div class="main-body">
                                                <div class="page-wrapper">
                                                    <!-- Page-header start -->
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="page-header-breadcrumb">
                                                                     <ul class="breadcrumb-title">
                                                                        ...
                                                                        <li class="breadcrumb-item"><a href="add_pelanggan.html">Tambah Pelanggan</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="card p-5">
                                                                    <div class="card-header">
                                                                        <h1 class="text-center" style="font-size: 50px; font-family: 'Serif', sans-serif;">Edit Data Pelanggan</h1>
