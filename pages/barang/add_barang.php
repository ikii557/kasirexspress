    ...
    if (isset($_POST['simpan'])) {
        if (tambahbarang($_POST) > 0) {
            ...
            echo "<script>
                ...
                document.location.href = 'add_barang.php';
                </script>";
        }
    }
?>
                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <span class="container" style="font-size: 15px; font-family: 'Times New Roman', sans-serif;">add Barang</span>
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        <h4 style="font-size: 30px; font-family: 'Times New Roman', sans-serif;">Tambah Barang</h4>
                                                        <span>Edit barang berkaitan dengan nama brang,harga barang,stok barang</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="edit_barang.html">Edit Barang</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <form action="" method="POST">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="nama_barang" class="form-control" placeholder=" Tambah nama barang" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="harga" class="form-control" placeholder="Tambah harga" >
                                                                <span class="md-line"></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" name="jml_stock" class="form-control" placeholder="Tambah stok">
                                                                <span class="md-line"></span>
                                                            </div>
                                                        </div>
                                                        <button type="submit" name="simpan" class="btn btn-success float-right" style="border-radius: 10px;">Simpan</button>
                                                    </form>
