                                                ...
                                                <div class="col-md-6 col-xl-4">
                                                    <div class="card widget-card-1">
                                                        <div class="card-block">
                                                            <i class="icofont bi bi-chat-square-text-fill"></i>
                                                            <span class="text-c-blue f-w-600">Notifikasi Pelanggan</span>
                                                            <div style="font-size: 15px;"> <?php echo $total_pelanggan; ?></div>
                                                            <div>
                                                                <a href="notifikasi.php">
                                                                    <span class="f-left m-t-10 text-muted">
                                                                        <i class="fs-5 bi bi-eye text-c-blue p-2" >  </i>daftar notifikasi pelanggan
                                                                    </span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-6 col-xl-4">
                                                    <div class="card widget-card-1">
                                                        <div class="card-block-small">
                                                            ...
                                                            <span class="text-c-pink f-w-600">Notifikasi Transaksi</span>
                                                            <div style="font-size: 15px;"> <?php echo $total_transaksi; ?></div>
                                                            
                                                            <div>
                                                                <a href="notifikasi.php">
                                                                <span class="f-left m-t-10 text-muted">
                                                                    <i class="text-c-pink f-16 icofont bi-eye m-r-10">  </i>daftar notifikasi transaksi
                                                                </span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-xl-4">
                                                    <div class="card widget-card-1">
                                                        <div class="card-block-small">
                                                            ...
                                                            <span class="text-c-green f-w-600">Notifkiasi Barang</span>
                                                            <div style="font-size: 15px;"> <?php echo $total_barang; ?></div>
                                                           
                                                            <div>
                                                                <a href="notifikasi.php">
                                                                <span class="f-left m-t-10 text-muted">
                                                                    <i class="text-c-pink f-16 icofont bi-eye m-r-10">  </i>daftar notifikasi barang
                                                                </span></a>
                                                            </div>
                                                        </div>
                                                    </div>
