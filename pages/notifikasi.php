                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left" >
                            <li class="header-notification m-t-9 active" style="font-size: 15px;">
                                <span class=" m-t-9" style="font-size: 15px; font-family: 'Times New Roman', sans-serif;">Kasirexspress</span>
                            </li>
                        </ul>
                        <ul class="nav-right">
                            <li class="header-notification active">
                                <a href="notifikasi.html">
                                    <i class="ti-bell"><b></b></i>
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="row">                                            
                                            <div class="col-sm-12">
                                            <a href="notif.php" class="btn btn-primary btn- mb-2" style="border-radius: 5px;">Back</a><br>
                                            
                                            
                                                    <div class="card p-5">
                                                        <span  style="font-size: 30px; font-family: 'Times New Roman', sans-serif;">Notifikasi Pelanggan</span>
                                                        <div class="card-header">
                                                        
                                                        
                                                            <!-- Notifikasi Hari Ini -->
                                                                    <?php
                                                                    // Jika $pelanggan adalah array multi-dimensi
                                                                        if (is_array($pelanggan) && count($pelanggan) > 0) {
                                                                            foreach ($pelanggan as $item) {
                                                                                // Pastikan 'nama' ada dalam setiap elemen array
                                                                                echo "<p>Nama Pelanggan: " . htmlspecialchars($item['nama']) . " bergabung sebagai pelanggan</p>";
                                                                            }
                                                                        } else {
                                                    ...
                                                    <div class="card p-5" >
                                                        <span  style="font-size: 30px; font-family: 'Helvetica', sans-serif;">Notifikasi Barang</span>
                                                        <div class="card-header">
                                                            ...
                                                            <!-- Notifikasi Hari Ini -->
                                                                    <?php
                                                                        // Jika $pelanggan adalah array multi-dimensi
                                                                        if (is_array($barang) && count($barang) > 0) {
                                                                            foreach ($barang as $item) {
                                                                                // Pastikan 'nama' ada dalam setiap elemen array
                                                                                echo "<p>Barang:  " . htmlspecialchars($item['nama_barang']) . " telah di tambahkan</p>";
                                                                            }
                                                                        } else {
                                                                            echo "<p>Data pelanggan tidak ditemukan.</p>";
                                                                        }
                                                    ...
                                                    <div class="card p-5">
                                                        <span  style="font-size: 30px; font-family: 'Helvetica', sans-serif;">Notifikasi Transaksi</span>
                                                        <div class="card-header">
                                                            ...
                                                            <?php
                                                                    // Jika $pelanggan adalah array multi-dimensi
                                                                    if (is_array($transaksi) && count($transaksi) > 0) {
                                                                        foreach ($transaksi as $item) {
                                                                            // Pastikan 'nama' ada dalam setiap elemen array
                                                                            echo "<p>pemberitahuan transkasi: " . htmlspecialchars($item['nama_pelanggan']) . " telah berhasil</p>";
                                                                        }
                                                                    } else {
                                                                        echo "<p>Data pelanggan tidak ditemukan.</p>";
                                                                    }
